...
class XsuiteSimulation(object):
    ...
    def run(self):
        ...
        '''
        #Setting the context - Here the device to perform the calculations is chosen
        ...
        #tracking
        tracker = self.track(xtrack_elements, xparticles)
    ...
    def track(self, xtrack_elements, xparticles):
